		...
		handler.post(new Runnable() {	//기본 핸들러니깐 handler.post하면됨
			...
			public void run() {
				...
				if(tResponse){		//문서를 다 읽었다
					tResponse=false;
					data=0;		//
					DustOpenAPIActivity.FindDustThreadResponse(sTotalCount,sDate,sSo2Value,sCoValue,sO3Value,sNo2Value,sPm10Value,sKhaiValue,sKhaiGrade,sSo2Grade,sNo2Grade,sCoGrade,sO3Grade,sPm10Grade);
